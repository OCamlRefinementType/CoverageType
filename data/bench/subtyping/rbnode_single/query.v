...
Module Type Signatures.
  ...
  Axiom rbtree_rb_leaf_no_rb_root_color : forall (l : rbtree Z), forall (x : Prop), rb_leaf l -> ~rb_root_color l x.
...
Module Axioms : Signatures.
  ...
  Lemma rbtree_rb_leaf_no_rb_root_color : forall (l : rbtree Z), forall (x : Prop), rb_leaf l -> ~rb_root_color l x. Admitted.
