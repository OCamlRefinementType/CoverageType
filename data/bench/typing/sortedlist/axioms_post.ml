...
let[@axiom] list_tl_sorted = fun (l : (int list)) (l1 : (int list)) -> (((tl l l1) && (sorted l)) #==> (sorted l1))
let[@axiom] list_hd_sorted = fun (l : (int list)) (l1 : (int list)) (x : int) (y : int) -> (((tl l l1) && (sorted l)) #==> ((emp l1) || (((hd l1 y) && (hd l x)) #==> (x <= y))))