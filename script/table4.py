...
benchmarks =  {
    "type_eq": "type_eq",
    "gen_type": "gen_type_size",
    "vars_with_type": "vars_with_type_rev_index",
    "gen_term_no_app": "gen_term_no_app",
    "gen_term_size": "gen_term_size"
}
...
if __name__ == '__main__':
    ...
    try:
        ...
        if_verbose = False
    run_bench.run("data/PLDI23/stlc/stlc.ml", if_verbose)
    data = {}
    try:
